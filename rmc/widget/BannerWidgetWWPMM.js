...
// alert("bannerwidgetwwpmm");

dojo.provide("rmc.widget.BannerWidgetWWPMM");

dojo.widget.defineWidget(
	"rmc.widget.BannerWidget",		
	dojo.widget.HtmlWidget,
	{
		templatePath: dojo.uri.dojoUri("../rmc/widget/templates/BannerWidgetWWPMM.html"),
		templateCssPath: dojo.uri.dojoUri("../rmc/widget/templates/BannerWidgetWWPMM.css"),
